...
menu = st.sidebar.radio("Pilih Halaman", ["Dashboard", "Manajemen IP Address", "Konfigurasi Wireless", "Monitoring Bandwidth"])
...
if menu == "Dashboard":
    ...
    - **Monitoring Bandwidth**: Memantau lalu lintas jaringan secara real-time.
    """)
